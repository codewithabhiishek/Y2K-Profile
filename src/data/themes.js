/* ProfileExE — Theme Definitions
   10 curated, distinctive colorways. Each theme controls every surface:
...
export var THEMES = [
  ...
  {id:"sakura",name:"SAKURA ZEN",era:"2002 · MINIMAL",sf:"sf-bevel",scan:.06,rad:"3px",fd:"var(--f-crt)",fb:"var(--f-ui)",
   c:{bg:"#14050b",deep:"#0c0206",panel:"#200d14",panel2:"#2c131c",ink:"#ffe4e8",muted:"#a86d77",line:"#52202a",hi:"#823544",lo:"#0f0308",pri:"#ff758f",sec:"#ffb3c1",acc:"#ff4d6d"},sw:["#ff758f","#200d14","#ff4d6d"]},
  ...
  {id:"cosmos",name:"COSMOS-VOID",era:"2003 · SPACE",sf:"sf-glow",scan:.08,rad:"3px",fd:"var(--f-crt)",fb:"var(--f-ui)",
   c:{bg:"#090619",deep:"#05030f",panel:"#130e2e",panel2:"#1c1542",ink:"#ede8ff",muted:"#8477ab",line:"#3e326b",hi:"#6250a6",lo:"#070414",pri:"#a78bfa",sec:"#c8b8ff",acc:"#f72585"},sw:["#a78bfa","#130e2e","#f72585"]},
  ...
  {id:"neoncity",name:"NEON CITY",era:"2000 · MEGAPLEX",sf:"sf-glow",scan:.1,rad:"2px",fd:"var(--f-crt)",fb:"var(--f-ui)",
   c:{bg:"#0e0417",deep:"#08020e",panel:"#190a29",panel2:"#24103a",ink:"#fae8ff",muted:"#996ca6",line:"#4c2466",hi:"#7b3c9e",lo:"#0a0212",pri:"#bf00ff",sec:"#e0aaff",acc:"#00f0ff"},sw:["#bf00ff","#190a29","#00f0ff"]}
];
