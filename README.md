...
## 🎨 10 Curated Theme Skins

Every surface — site chrome, template previews, live AI compiler, and SVG studio — synchronizes across 10 bespoke colorways:

- 🟢 **PHOSPHOR-01** (1999 CRT Matrix Green)
- 🟡 **AMBER-88** (1984 UNIX Terminal Monochrome)
- 🔵 **CYBERGRID** (2001 Netrunner Cyan & Gold)
- ⚪ **ICE.CHROME** (1999 Frost Messenger & Glassmorphism Light Mode)
- 🔘 **LIQUID CHROME** (2000 Winamp Brushed Metal & Electric Blue)
- 🍏 **ACID RAVE** (1998 Underground Toxic Lime Flyer)
- 🔴 **RED ALERT** (1997 Military Tactical Ops Crimson)
- 🌟 **HOLO-FOIL** (2001 PSA Gem Mint 10 Holo Card)
- 🕹️ **DMG-8BIT** (1989 Nintendo Game Boy Olive Pixel)
- 🔥 **AFTERBURNER** (2000 Overclocked Molten Orange)
...
### 1. Clone & Install
```bash
git clone https://github.com/codewithabhiishek/Y2K-Profile.git
cd Y2K-Profile
npm install
```
...
Feel free to check the [issues page](https://github.com/codewithabhiishek/Y2K-Profile/issues).

1. Fork the Project
2. Create your Feature Branch (`git checkout -b feature/EpicNewTheme`)
3. Commit your Changes (`git commit -m 'feat: add Cyberpunk 2077 Theme'`)
4. Push to the Branch (`git push origin feature/EpicNewTheme`)
...
<div align="center">
  <sub>Built with ⚡ past midnight · 100% free · Zero watermarks</sub>
</div>
